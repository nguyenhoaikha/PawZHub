--[[
    ...
    ==================================
    Fetches and inits `lib/movement.lua` for the current game script.
    ...
    See lib/movement.lua for the full API (28 functions).
]]

local Bootstrap = {}

local RAW = "https://raw.githubusercontent.com/nguyenhoaikha/PawZHub/main/lib/movement.lua"
